...
export interface ListOrgUnitsInput { readonly organizationId: string; readonly activeOnly?: boolean; }
...
export interface OrganizationService {
  ...
  listOrgUnits(input: ListOrgUnitsInput): Promise<readonly OrgUnitDto[]>;
}
